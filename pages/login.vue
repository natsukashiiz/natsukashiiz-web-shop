      ...
      <div class="w-full bg-white rounded-lg shadow mt-20 sm:max-w-md xl:p-0">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          >
            ...
            <button
              type="submit"
              class="w-full text-white bg-rose-400 hover:bg-rose-500 focus:ring-2 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm px-3 py-1.5 text-center"
            >
              เข้าสู่ระบบ
            </button>
